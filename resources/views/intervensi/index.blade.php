...
<div class="row">
    <div class="col-12 grid-margin stretch-card">
        ...
        <button class="btn btn-info btn-sm" id="btn-create"><span class="fa fa-plus"></span> Tambah
            Jenis</button><br><br>
                ...
                @foreach($intervensi as $intervensi)
                    <tr>
                        ...
                        <td class="text-center" style="width: 22%">
                            <button class="btn btn-warning btn-edit btn-sm" id="{{ $intervensi->id }}"><span
                                    class="fa fa-pen"></span> Edit</button>
                            <button class="btn btn-danger btn-delete btn-sm" id="{{ $intervensi->id }}"><span
