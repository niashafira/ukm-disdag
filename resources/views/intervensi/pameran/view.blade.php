...
@section('content')
    ...
    <div class="row" style="margin-bottom: 3%">
        <div class="col-12">
            <a :href="'/intervensi/pameran/edit/'+ intervensi.id" class="btn btn-sm btn-warning"><span class="fa fa-pen"></span> Edit</a>
    ...
    <table class="table table-striped" style="font-size: 14px;">
        <tr>
            <td style="width: 15%">Nama Pameran</td>
            <td style="width: 2%"> : </td>
...
@section('script')
    @include('intervensi.pameran.viewJs')
@endsection
