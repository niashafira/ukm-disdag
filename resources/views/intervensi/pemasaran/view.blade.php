...
@section('content')
    ...
    <div class="row" style="margin-bottom: 3%">
        <div class="col-12">
            ...
            <a :href="'/intervensi/pemasaran/edit/'+ intervensi.id" class="btn btn-sm btn-warning"><span class="fa fa-pen"></span> Edit</a>
        </div>
    </div>
    ...
    <table class="table table-striped" style="font-size: 14px;">
        <tr>
            <td style="width: 15%">Nama Pemasaran</td>
            <td style="width: 2%"> : </td>
...
@section('script')
    @include('intervensi.pemasaran.viewJs')
@endsection
