...
@section('content')
    ...
    <h3>Detail Pemasaran</h3>
    <hr>
    <form id="form-intervensi">
    <table class="table table-striped" style="font-size: 14px;">
            <tr>
                <td class="align-middle" style="width: 15%">Nama Pemasaran</td>
                <td class="align-middle" style="width: 2%"> : </td>
                <td class="align-middle">
                    <div class="form-group" style="margin-bottom: 0">
                        <input name="nama_intervensi" v-model="intervensi.nama_intervensi" type="text" class="form-control form-control-sm" placeholder="Nama Pameran">
                    </div>
                </td>
            </tr>
            <tr>
...
@section('script')
    @include('intervensi.pemasaran.formJs')
@endsection
