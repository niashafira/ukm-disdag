...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <a v-if="mode == 'view'" :href="'/intervensi/lainnya/edit/'+ intervensi.id" class="btn btn-sm btn-info" style="float:right; margin-left:10px"><span class="fa fa-pen"></span> Edit</a>
            ...
            <a :href="'/intervensi/lainnya'" class="btn btn-sm btn-warning" style="float:right;"><span class="fa fa-arrow-left"></span> Kembali</a>
        </div>
    </div>

    <h3>Intervensi Lainnya</h3>
    <hr>
    <form id="form-ref">
        <div class="row">
            <div class="col">
                <div class="form-group">
                    ...
                    <input {{ $mode == 'view' ? 'readonly' : '' }} v-model="intervensi.nama_intervensi" autocomplete="off" type="text" class="form-control" placeholder="Nama intervensi">
                </div>
            </div>
            <div class="col">
                <div class="form-group">
                    <label>Deskripsi</label>
                    <input {{ $mode == 'view' ? 'readonly' : '' }} v-model="intervensi.deskripsi" autocomplete="off" type="text" class="form-control" placeholder="Deskripsi intervensi">
                </div>
            </div>
        </div>
        <div class="row">
...
var app = new Vue({
    ...
    data: {
        api:{
            dataUkm: "/api/ukm",
            export: "/intervensi/lainnya/export"
        },
        intervensi: {
            jenis_intervensi: "lainnya",
            nama_intervensi: "",
            deskripsi: "",
            lokasi: "",
            tanggal_mulai: "",
        ...
        submit(){
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    var url = "/intervensi/lainnya/store";
                    if(this.mode == "edit"){
                        url = "/intervensi/lainnya/update";
                    }
