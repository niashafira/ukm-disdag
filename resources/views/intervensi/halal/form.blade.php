...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            ...
            <a :href="'/intervensi/halal'" class="btn btn-sm btn-warning" style="float:right;"><span class="fa fa-arrow-left"></span> Kembali</a>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col">
                <div class="form-group">
                    ...
                    <input {{ $mode == 'view' ? 'readonly' : '' }} v-model="intervensi.nama_intervensi" autocomplete="off" type="text" class="form-control" placeholder="No. Pendaftaran">
                </div>
            </div>
            <div class="col-4">
                <div class="form-group">
        ...
        <div class="row">
            <div class="col">
                <div class="form-group">
                    ...
                    <input {{ $mode == 'view' ? 'readonly' : '' }} v-model="intervensi.deskripsi" autocomplete="off" type="text" class="form-control" placeholder="Deskripsi">
                </div>
            </div>
        </div>
    </form>
...
var app = new Vue({
        ...
        data: {
            ...
            intervensi: {
                jenis_intervensi: "sertifikat halal",
                nama_intervensi: "",
                deskripsi: "",
                tanggal_mulai: "",
                tanggal_selesai: ""
