...
@section('content')
    ...
    <table class="table table-striped" style="font-size: 14px;">
            ...
            <tr>
                <td class="align-middle" style="width: 15%">Nama Merek</td>
                <td class="align-middle" style="width: 2%"> : </td>
                <td class="align-middle">
                    <div class="form-group" style="margin-bottom: 0">
                        <input name="nama_merek" v-model="intervensi.nama_merek" type="text" class="form-control form-control-sm" placeholder="Nama Merek">
                    </div>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="align-middle" style="width: 15%">No Permohonan</td>
                <td class="align-middle" style="width: 2%"> : </td>
                <td class="align-middle">
                    <div class="form-group" style="margin-bottom: 0">
                        <input name="no_permohonan" v-model="intervensi.no_permohonan" type="text" class="form-control form-control-sm" placeholder="No Permohonan">
                    </div>
                </td>
            </tr>
            <tr>
                <td class="align-middle">Tanggal Berkas Kemenkumham</td>
                <td class="align-middle"> : </td>
                <td class="align-middle">
                    <div class="form-group" style="margin-bottom: 0">
                        <input name="tgl_berkas_kemenkumham" v-model="intervensi.tgl_berkas_kemenkumham" type="date" class="form-control form-control-sm">
                    </div>
                </td>
            </tr>
            <tr>
...
@section('script')
    @include('intervensi.merek.formJs')
@endsection
