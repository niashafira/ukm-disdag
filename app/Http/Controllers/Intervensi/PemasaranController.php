...
class PemasaranController extends Controller
{
    ...
    public function exportExcel(Request $request){
        ...
        // $sheet->setCellValue("A3", "Tanggal Mulai : " . date("d-m-Y", strtotime($intervensi['tanggal_mulai'])));
        // $sheet->setCellValue("A4", "Tanggal Selesai : " . date("d-m-Y", strtotime($intervensi['tanggal_selesai'])));
        $sheet->setCellValue("A3", "Deskripsi : {$intervensi['deskripsi']}");
        $sheet->setCellValue("A4", "Jumlah Peserta : " . count($data));
